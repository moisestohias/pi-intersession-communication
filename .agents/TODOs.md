...
4. [x] Disable the peerReplyHint (eg; `Reply with session_ask({ to_session_id: "01a09a39-40c5-73f2-9083-e34b71f4be9a", text: "…", in_reply_to: "m-907eb229ecdf" }) (or /peer allow first if that session is not in your allowlist).`)